...
def _project_root() -> Path:
    """ Папка, где лежит config.py (корень проекта при разработке) """
...
# Реплики
REPLICAS_DIR = ASSETS_DIR / 'replicas'
...
_DEFAULTS: dict = {
    # Персонаж
    'pet_scale': 1.0,
    'pet_start_position': 'bottom-right',
    'pet_span_all_screens': True,
...
_SETTINGS_HELP: dict = {
    ...
    'pet_span_all_screens':
        ...
        'Клики мимо питомца всё равно уходят в приложения под ним.',
